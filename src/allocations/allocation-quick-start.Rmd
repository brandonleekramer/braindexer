...
```{r}
# subgraph stats
current_subgraph_signal = as.numeric(str_replace_all("4,226.47",",",""))
current_subgraph_stake = as.numeric(str_replace_all("3,700,232.00",",",""))
...
new_subgraph_stake = current_subgraph_stake + 500000
